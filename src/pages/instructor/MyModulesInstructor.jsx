...
const MyCoursesInstructor = () => {
  ...
  const handleAddModule = async (e) => {
    ...
    try {
      await axios.post(`${API_BASE_URL}/users/modules`, {
        title: moduleTitle,
...
const handleAddExistingContentToModule = async (contentId) => {
  ...
  try {
    ...
    toast.success("Content attached successfully");
    setShowAddContent(false);
    fetchModules();
  } catch (err) {
    toast.error(
      err.response?.data?.message || "Failed to attach content to module"
    );
  }
};
...
const handleEnrollTrainee = async (e) => {
  ...
  try {
    ...
    toast.error(
      err.response?.data?.message || "Failed to enroll trainees"
    );
  }
};
    ...
    <div className="container py-4 page-content">
      ...
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4">
        ...
        <Button
          ...
          style={{ backgroundColor: "#766EA9", borderColor: "#004d00" }}
        >
        ...
        {modules.length > 0 ? (
          modules.map((module) => (
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(3, 159, 170, 0.2), rgba(0,255,128,0.2))",
                color: "#003300",
              }}
            >
